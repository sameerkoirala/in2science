...
<head>
    ...
    <style type="text/css">
        ...
        /*}*/
        body{
            background-image: url("{{asset('img/in2science.png')}}");
...
<script type="application/javascript">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (typeof(data.period1) !== "undefined"){
                    ...
                    var label = document.createTextNode(data.period1);
                ...
                if (typeof(data.period2) !== "undefined"){
                    ...
                    var label = document.createTextNode(data.period2);
                ...
                if (typeof(data.period3) !== "undefined") {
                    ...
                    var label = document.createTextNode(data.period3);
                ...
                if (typeof(data.period4) !== "undefined"){
                    ...
                    var label = document.createTextNode(data.period4);
                ...
                if (typeof(data.period5) !== "undefined"){
                    ...
                    var label = document.createTextNode(data.period5);
                ...
                if (typeof(data.period6) !== "undefined"){
                    ...
                    var label = document.createTextNode(data.period6);
    ...
    function showTimeForm2($volunteer) {
        $('#volTimeForm').hide();
        $('#volTimeForm2').show();
        $('#mentorId').val($volunteer.mentorId);
    }
